...
document.getElementById('productImg').src =productData.preview; ;
...
let getImg = productData.photos;
let getImgTag = document.getElementsByClassName('get-img');

for (let i = 0; i < getImg.length; i++){
    getImgTag[i].src = getImg[i];
}
...
function imageClicked(activeImageID) {
    ...
    var activeSmallImage = document.getElementById(activeImageID);
    activeSmallImage.classList.add('active');
    var bigImage = document.getElementById('productImg');
    bigImage.src = activeSmallImage.src;
}
